...
void three_link(char arr[jihang][jihang]);

int succeed(char arr[jihang][jihang]);

int add_succeed(char arr[jihang][jihang]);

void one_link(char arr[jihang][jihang]);

void two_link(char arr[jihang][jihang]);

void two_link_d(char arr[jihang][jihang]);

void three_link_d(char arr[jihang][jihang]);
