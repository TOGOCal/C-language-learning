...
void jineng()
{
    ...
    if(ji==1)
    {
        char arr_3[200]={"C7]CQ74P8]CW1H39MA17BO9r2i1D6Be5EMFo5n3qEAy4h3982Ba768rBs0vA5FL3N2EVBs7R4t8T4FES2t3a993\0"};
        Chinese(arr_3);
        Sleep(3000);
    ...
    if(ji==2)
    {
        char arr_0[200]={"CH7C748C139A14F7929D6481C0D0DZ3982Ab69S25E3F1A0EA1595E3F6D4Z93E6dCE2PB06B3F3869F36BE2A6C02C3993\0"};
        Chinese(arr_0);
        Sleep(3000);
        int cs=chachong();
        if(cs!=3)
    ...
    if(ji==3)
    {
        char arr_arr[200]={"C7C748C13r9AK14Fd3CB0480D7B4995398249u9h5A6ZF5492F2Ej4SAKAa6925RE3MF29F4W7C6B7B5B1D3D3993\0"};
        Chinese(arr_arr);
        Sleep(3000);
        int z_x=rand()%10+5;
        int z_y=rand()%10+5;
    ...
    if(ji==4)
    {
        char arr_arr1[200]={"C7OC7i48C139qAv1D1E1a1A6wAu0CkBi4J3fEq58t3982HA6922FBQ0L0Di93f6JA5gB7Ay3JE5V9W1Cj1A4LAf3X993n\0"};
        Chinese(arr_arr1);
        Sleep(3000);
        int wi=rand()%2;
        if(wi==1)
        {
            char arr_arr2[200]={"1AEM5V4FE2yD]6VBX1A6OF46SDCn7cA1]CK1U6UBp2KF3W8FU339Cs6Dq1fE11A6An0cCB4q3Es5q8A6k7D0BsCM1K\0"};
            Chinese(arr_arr2);
            Sleep(3000);
            return ;
        }
...
void jineng2()
{
    char arr_arr6[200]={"0iC4LA844xFEX24_F_D6O1nFAg68N7V39qCY67IBTB5X9e54n9A1b3jCb499^4Ab649\0"};
    ei:
    system("cls");
    printf("1,\n");
    char arr_3[200]={"C7]CQ74P8]CW1H39MA17BO9r2i1D6Be5EMFo5n3qEAy4h3982Ba768rBs0vA5FL3N2EVBs7R4t8T4FES2t3a993\0"};
    ...
    char arr_arr5[200]={"0^C4nA84q4FS3Y9fA_1t\0"};
    Chinese(arr_arr5);
    printf("%d\n",cold1);
    printf("\n");

    printf("2,\n");
    char arr_arr3[200]={"3N8s0EF3N6l90BEW2t5EU6nDn39Y82^A69T2X2FB06Dc827C6QDE2^7OD4q8mAf7l7B5YBf6A1sDX39L9w3\0"};
    Chinese(arr_arr3);
    char arr_arr7[200]={"0ZB4F_F32[EBe08M5g3n85ED61JFTA68N7q3n8UCj0]0PD2LDg\0"};
    ...
    printf("3,\n");
    char arr_arr0[200]={"0B5HE6oD84x3c8i2Eq296dB3t98258l82H5EsFV53YEJ0dD7KA8y65E29P0tDK7D92IBj43d9V9d3\0"};
    char arr_arr9[200]={"4[9AW7a6B8m3q6QD825E8u5`5EV3qDU2YE1EZFn32`E58t82s5EF53S9XC6DV6lB149mAM7n30WBl085A^1]FU3A1n3C1ACf65j8b8R2\0"};
    Chinese(arr_arr0);
    Chinese(arr_arr9);
    Chinese(arr_arr5);
    printf("%d\n",cold3);
...
void teach()
{
    ...
    // Chinese(arr_5);
    // Sleep(1145);
    char arr_arr8[200]={"49A7AO6S4qAg84B5m7A871AAL4Ap61wAAj64A8V4xB5F458n83I1]EJF49I5Bg0Dd63W86i9CR7hC_74x8sC13nFt68k0BI5pBb\0"};
    Chinese (arr_arr8);
    Sleep(1145);
    Chinese(arr_5);
    Sleep(1145);
...
void arrcheck()
{
    for (int jihang1=0;jihang1<jihang;jihang1++)
    {
        for(int jihang2=0;jihang2<jihang;jihang2++)
        {
            if(arr[jihang1][jihang2]!=' '&&arr[jihang1][jihang2]!='1'&&arr[jihang1][jihang2]!='0'&&arr[jihang1][jihang2]!='!')
            {
